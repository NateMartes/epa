...
class Post(BaseModel):
    ...
    title: StrictStr
    content: StrictStr
    category_slug: StrictStr = Field(description="URL-friendly identifier for the category.")
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["post_id", "created_by", "title", "content", "category_slug", "created_at"]
