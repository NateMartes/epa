...
class SubscribeCategoryRequest(BaseModel):
    ...
    """ # noqa: E501
    category_id: StrictStr = Field(description="The ID of the category, also know as the category slug")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SubscribeCategoryRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SubscribeCategoryRequest from a dict"""
        if obj is None:
            return None
